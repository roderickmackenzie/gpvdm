...
class pl_experiment(experiment):
	...
	def __init__(self,data=None):
		experiment.__init__(self,window_save_name="plexperiment_editor", window_title=_("PL experiment window"),name_of_tab_class="plexperiment_tab",json_search_path="gpvdm_data().pl_ss")

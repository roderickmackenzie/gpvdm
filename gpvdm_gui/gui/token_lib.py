...
class my_data():
	...
	units=""
	info=""
	def __init__(self,a,b,info,e,f,widget,defaults=None,units_widget="QLabel",min=None,max=None,hidden=False,hide_on_true_token="none",hide_on_false_token=[],hide_on_token_eq=None):
		self.token=a
		self.units=b
		self.info=info
...
def build_token_lib():
	...
	lib.append(my_data("lpoints","au",_("Mesh points (lambda)"),"e",1.0,"QLineEdit",hide_on_true_token="light_wavelength_auto_mesh"))
	lib.append(my_data("lstart","m",_("Lambda start"),"e",1.0,"QLineEdit",hide_on_true_token="light_wavelength_auto_mesh"))
	lib.append(my_data("lstop","m",_("Lambda stop"),"e",1.0,"QLineEdit",hide_on_true_token="light_wavelength_auto_mesh"))
	...
	lib.append(my_data("light_multiplyer","au",_("Light multiplyer"),"e",1.0,"QLineEdit"))
	lib.append(my_data("light_iluminate_from","au",_("Iluminate from"),"e",1.0,"QComboBoxLang",defaults=[[("y0"),_("Left")],[("y1"),_("Right")]]))

	#sim_info.dat from light
	lib.append(my_data("J_photo","Am^{-2}",_("Photo current density"),"e",1.0,"QLineEdit"))
	lib.append(my_data("I_photo","A",_("Photo current"),"e",1.0,"QLineEdit"))
	...
	#layer widget
	lib.append(my_data("solve_optical_problem","type",_("Solve optical problem"),"e",1.0,"QComboBoxLang",defaults=[[("true"),_("Yes")],["false",_("No")]]))
	lib.append(my_data("solve_thermal_problem","type",_("Solve optical problem"),"e",1.0,"QComboBoxLang",defaults=[[("true"),_("Yes")],["false",_("No")]]))
	lib.append(my_data("layer_type","type",_("Layer type"),"e",1.0,"QComboBoxLang",defaults=[[("contact"),_("contact")],["active",_("active layer")],["other",_("other")]]))

	#dos?.inp
	lib.append(my_data("dostype","Edit",_("DoS distribution"),"s",1.0,"generic_switch",units_widget="QPushButton",defaults=[[_("Complex"),"complex"],[_("Exponential"),"exponential"]],hide_on_token_eq=[["srh_bands",0]]))
	...
	lib.append(my_data("T_start","K",_("Start temperature"),"e",1.0,"QLineEdit"))
	lib.append(my_data("T_stop","K",_("Stop temperature"),"e",1.0,"QLineEdit"))
	lib.append(my_data("T_steps","au",_("Temperature steps"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("Ntrape","m^{-3} eV^{-1}",_("Electron trap density"),"e",1.0,"QLineEdit",min=1e10,max=1e27,hide_on_token_eq=[["dostype","complex"],["srh_bands",0]] ))
	lib.append(my_data("Ntraph","m^{-3} eV^{-1}",_("Hole trap density"),"e",1.0,"QLineEdit",min=1e10,max=1e27,hide_on_token_eq=[["dostype","complex"],["srh_bands",0]] ))
	lib.append(my_data("Etrape","eV",_("Electron tail slope"),"e",1.0,"QLineEdit",min=20e-3,max=150e-3,hide_on_token_eq=[["dostype","complex"],["srh_bands",0]] ))
	lib.append(my_data("Etraph","eV",_("Hole tail slope"),"e",1.0,"QLineEdit",min=20e-3,max=150e-3,hide_on_token_eq=[["dostype","complex"],["srh_bands",0]] ))
	lib.append(my_data("epsilonr","au",_("Relative permittivity"),"e",1.0,"QLineEdit",min=1.0,max=10.0 ))
	lib.append(my_data("srhsigman_e","m^{-2}",_("Free electron to Trapped electron"),"e",1.0,"QLineEdit",min=1e-27,max=1e-15,hide_on_token_eq=[["srh_bands",0]] ))
	lib.append(my_data("srhsigmap_e","m^{-2}",_("Trapped electron to Free hole"),"e",1.0,"QLineEdit",min=1e-27,max=1e-15,hide_on_token_eq=[["srh_bands",0]] ))
	lib.append(my_data("srhsigman_h","m^{-2}",_("Trapped hole to Free electron"),"e",1.0,"QLineEdit",min=1e-27,max=1e-15,hide_on_token_eq=[["srh_bands",0]] ))
	lib.append(my_data("srhsigmap_h","m^{-2}",_("Free hole to Trapped hole"),"e",1.0,"QLineEdit",min=1e-27,max=1e-15,hide_on_token_eq=[["srh_bands",0]]))
	...
	lib.append(my_data("material_blend",_("True/False"),_("Blended material"),"e",1.0,"gtkswitch" ))
	lib.append(my_data("Eg0","eV",_("Eg_{0}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("Xi0","eV",_("Xi_{0}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("Eg1","eV",_("Eg_{1}"),"e",1.0,"QLineEdit",hide_on_false_token=["material_blend"]))
	lib.append(my_data("Xi1","eV",_("Xi_{1}"),"e",1.0,"QLineEdit",hide_on_false_token=["material_blend"]))
	...
	lib.append(my_data("electrical_enable_generation",_("True/False"),_("Enable optical charge\ncarrier generation"),"e",1.0,"gtkswitch", hide_on_token_eq=[["electrical_component","resistance"],["electrical_component","link"]] ))


	#spm?.inp
	lib.append(my_data("spm_voltage","V",_("Applied voltage"),"e",1.0,"QLineEdit"))
	lib.append(my_data("spm_scan_section","su",_("Scan section"),"e",1.0,"QComboBoxLang",defaults=[[("spm_whole_device"),_("Whole device")],["spm_box",_("Box section")],["spm_x_cut",_("x-Scan")]]))
	lib.append(my_data("spm_x0","m",_("x-start"),"e",1.0,"QLineEdit",hide_on_token_eq=[["spm_scan_section","spm_whole_device"],["spm_scan_section","spm_x_cut"]]))
	lib.append(my_data("spm_z0","m",_("z-start"),"e",1.0,"QLineEdit",hide_on_token_eq=[["spm_scan_section","spm_whole_device"],["spm_scan_section","spm_x_cut"]]))
	lib.append(my_data("spm_x1","m",_("x-stop"),"e",1.0,"QLineEdit",hide_on_token_eq=[["spm_scan_section","spm_whole_device"],["spm_scan_section","spm_x_cut"]]))
	lib.append(my_data("spm_z1","m",_("z-stop"),"e",1.0,"QLineEdit",hide_on_token_eq=[["spm_scan_section","spm_whole_device"],["spm_scan_section","spm_x_cut"]]))

	#shape?.inp
	lib.append(my_data("shape_type",_("Edit"),_("Shape type"),"e",1.0,"gpvdm_select_shape",units_widget="QPushButton"))
	lib.append(my_data("rotate_y","degrees",_("Rotate around y-axis"),"e",1.0,"QLineEdit"))

	lib.append(my_data("dx","m",_("dx of the object"),"e",1.0,"QLineEdit"))
	lib.append(my_data("dy","m",_("dy of the object"),"e",1.0,"QLineEdit"))
	lib.append(my_data("dz","m",_("dz of the object"),"e",1.0,"QLineEdit"))

	lib.append(my_data("dx_padding","m",_("dx padding"),"e",1.0,"QLineEdit"))
	lib.append(my_data("dy_padding","m",_("dy padding"),"e",1.0,"QLineEdit"))
	lib.append(my_data("dz_padding","m",_("dz padding"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("x0","m",_("x offset"),"e",1.0,"QLineEdit"))
	lib.append(my_data("y0","m",_("y offset"),"e",1.0,"QLineEdit"))
	lib.append(my_data("z0","m",_("z offset"),"e",1.0,"QLineEdit"))
	lib.append(my_data("shape_remove_layer",_("True/False"),_("Remove layer"),"e",1.0,"gtkswitch"))
	lib.append(my_data("shape_dos",_("Edit"),_("Drift diffusion"),"e",1.0,"shape_dos_switch",units_widget="QPushButton"))
	lib.append(my_data("shape_electrical",_("Edit"),_("Circuit model\nparameters"),"e",1.0,"shape_electrical_switch",units_widget="QPushButton"))
	lib.append(my_data("optical_material",_("Edit"),_("Optical material"),"e",1.0,"gpvdm_select_material" ,units_widget="QPushButton"))
	lib.append(my_data("shape_flip_y",_("True/False"),_("Flip y"),"e",1.0,"gtkswitch"))
	lib.append(my_data("color_r","rgb",_("Color"),"e",1.0,"QColorPicker"))

	#interface?.inp
	lib.append(my_data("interface_model","type",_("Interface model"),"e",1.0,"QComboBoxLang",defaults=[[("none"),_("None")],["recombination",_("Free-to-Free")],["recombination_srh",_("Free-to-trap (SRH)")]]))
	...
	lib.append(my_data("interface_left_doping_enabled",_("True/False"),_("Interface doping LHS"),"e",1.0,"gtkswitch"))
	lib.append(my_data("interface_left_doping","m^{-3}",_("Doping LHS"),"e",1.0,"QLineEdit", hide_on_false_token=["interface_left_doping_enabled"]))

	lib.append(my_data("interface_right_doping_enabled",_("True/False"),_("Interface doping RHS"),"e",1.0,"gtkswitch"))
	lib.append(my_data("interface_right_doping","m^{-3}",_("Doping RHS"),"e",1.0,"QLineEdit", hide_on_false_token=["interface_right_doping_enabled"]))
	...
	#ref / bib
	lib.append(my_data("url","au",_("Website"),"e",1.0,"QLineEdit"))
	lib.append(my_data("author","au",_("Author"),"e",1.0,"QLineEdit"))
	lib.append(my_data("journal","au",_("Journal"),"e",1.0,"QLineEdit"))
	lib.append(my_data("title","au",_("Title"),"e",1.0,"QLineEdit"))
	lib.append(my_data("volume","au",_("Volume"),"e",1.0,"QLineEdit"))
	lib.append(my_data("pages","au",_("Pages"),"e",1.0,"QLineEdit"))
	lib.append(my_data("year","au",_("Year"),"e",1.0,"QLineEdit"))
	lib.append(my_data("DOI","au",_("DOI"),"e",1.0,"QLineEdit"))
	lib.append(my_data("booktitle","au",_("Book title"),"e",1.0,"QLineEdit"))
	lib.append(my_data("publisher","au",_("Publisher"),"e",1.0,"QLineEdit"))
	lib.append(my_data("isbn","au",_("ISBN"),"e",1.0,"QLineEdit"))
	lib.append(my_data("unformatted","au",_("Scraped text"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("jv_Rcontact","V",_("JV curve contact resistance"),"e",1.0,"QParasitic"))
	lib.append(my_data("jv_Rshunt","V",_("JV curve shunt resistance"),"e",1.0,"QParasitic"))
	...
	#mu
	lib.append(my_data("mue_pmax","m^{2}V^{-1}s^{-1}",_("Electron mobility at P_{max}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("muh_pmax","m^{2}V^{-1}s^{-1}",_("Hole mobility at P_{max}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("mu_jsc","m^{2}V^{-1}s^{-1}",_("Average mobility as J_{sc}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("mu_pmax","m^{2}V^{-1}s^{-1}",_("Average mobility at P_{max}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("mu_voc","m^{2}V^{-1}s^{-1}",_("Average mobility at V_{oc}"),"e",1.0,"QLineEdit"))

	#theta

	lib.append(my_data("theta_srh_free","au",_("Theta_{SRH} - free P_{max}"),"e",1.0,"QLineEdit"))
	lib.append(my_data("theta_srh_free_trap","au",_("Theta_{SRH} - free-trap P_{max}"),"e",1.0,"QLineEdit"))
	#tau
	lib.append(my_data("tau_pmax","m^{-1}",_("Recombination time constant"),"e",1.0,"QLineEdit"))
	lib.append(my_data("tau_voc","s",_("Recombination time constant at Voc"),"e",1.0,"QLineEdit"))
	lib.append(my_data("device_C","F",_("Device capacitance"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("server_use_dos_disk_cache",_("True/False"),_("Store DoS on disk"),"e",1.0,"gtkswitch"))
	...
	lib.append(my_data("cluster_master_ip","au","Cluster master IP","e",1.0,"QLineEdit"))
	lib.append(my_data("cluster_cluster_dir","au",_("Remote cluster directory"),"e",1.0,"QLineEdit"))
	lib.append(my_data("cluster_node_list","au",_("Remote node list"),"e",1.0,"QLineEdit"))
	lib.append(my_data("cluster_iv","au",_("IV"),"e",1.0,"QLineEdit"))
	lib.append(my_data("cluster_key","au",_("Key"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("mesh_min_ang","au",_("Min allowable angle"),"e",1.0,"QLineEdit"))
	...
	lib.append(my_data("image_ylen","pixels",_("y size"),"e",1.0,"QLineEdit"))
	lib.append(my_data("image_xlen","pixels",_("x size"),"e",1.0,"QLineEdit"))


	#honeycomb
	lib.append(my_data("shape_import_blur","pixels",_("pixels"),"e",1.0,"QLineEdit"))
	...
	#math.inp
	lib.append(my_data("maxelectricalitt_first","au",_("Max Electrical itterations (first step)"),"e",1.0,"QLineEdit"))
	lib.append(my_data("electricalclamp_first","au",_("Electrical clamp (first step)"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_electrical_error_first","au",_("Desired electrical solver error (first step)"),"e",1.0,"QLineEdit"))
	lib.append(my_data("maxelectricalitt","au",_("Max electrical itterations"),"e",1.0,"QLineEdit"))
	lib.append(my_data("electricalclamp","au",_("Electrical clamp"),"e",1.0,"QLineEdit"))
	lib.append(my_data("electricalerror","au",_("Minimum electrical error"),"e",1.0,"QLineEdit"))



	lib.append(my_data("newton_clever_exit",_("True/False"),"Newton solver clever exit","e",1.0,"gtkswitch"))
	lib.append(my_data("newton_min_itt","au",_("Newton minimum iterations"),"e",1.0,"QLineEdit"))
	lib.append(my_data("complex_solver_name",_("dll name"),_("Complex matrix solver to use"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_stop_on_convergence_problem",_("True/False"),_("Quit on convergence problem"),"e",1.0,"gtkswitch"))

	#pos
	lib.append(my_data("pos_max_ittr","au",_("Poisson solver max itterations"),"e",1.0,"QLineEdit"))
	lib.append(my_data("pos_min_error","au",_("Minimum electrical error"),"e",1.0,"QLineEdit"))
	lib.append(my_data("posclamp","au",_("Poisson clamping"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_enable_pos_solver",_("True/False"),_("Enable poisson solver"),"e",1.0,"gtkswitch"))
	lib.append(my_data("pos_dump_verbosity","au",_("Output verbosity to disk"),"e",1.0,"QComboBoxLang",defaults=[["0",_("Nothing")],[("1"),_("Write everything to disk")]]))

	lib.append(my_data("solver_name",_("dll name"),_("Matrix solver"),"e",1.0,"QComboBoxNewtonSelect",defaults=["umfpack","external_solver","superlu","nr_d","nr_ld"]))

	lib.append(my_data("newton_name",_("dll name"),_("Newton solver to use"),"e",1.0,"QComboBoxNewtonSelect",defaults=["none","newton_2d","newton_norm","newton","poisson_2d"]))
	lib.append(my_data("math_t0","au",_("Slotboom T0"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_d0","au",_("Slotboom D0"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_n0","au",_("Slotboom n0"),"e",1.0,"QLineEdit"))
	lib.append(my_data("math_newton_cache","au",_("Use newton cache (experimental)"),"e",1.0,"gtkswitch"))
	lib.append(my_data("kl_in_newton","au",_("Solve Kirchhoff's current law in Newton solver"),"e",1.0,"gtkswitch"))
	...
	lib.append(my_data("fit_simplexmul","au",_("Start simplex step multiplication"),"e",1.0,"QLineEdit"))
	lib.append(my_data("fit_simplex_reset","au",_("Simplex reset steps"),"e",1.0,"QLineEdit"))
	lib.append(my_data("fit_set_error_to_zero_before","au",_("Set error to zero before"),"e",1.0,"QLineEdit"))

	#eqe.inp
	lib.append(my_data("eqe_voltage","au",_("EQE Voltage"),"e",1.0,"QLineEdit"))

	#thermal.inp
	lib.append(my_data("thermal_model_type","au",_("Thermal model type"),"s",1.0,"QComboBoxLang",defaults=[["thermal_hydrodynamic",_("Hydrodynamic")],["thermal_lattice",_("Lattice heat")]], hide_on_false_token=["thermal"]))

	lib.append(my_data("Ty0","Kelvin",_("Device temperature at y_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Ty0_boundry", "neumann"]]))
	lib.append(my_data("Ty0_boundry","au",_("Boundary condition for y_{min}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_y0","W m^{-}K^{-1}",_("Conductivity of heat sink y_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Ty0_boundry", "neumann"],["Ty0_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_y0","m",_("Heat sink length y_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Ty0_boundry", "neumann"],["Ty0_boundry", "isothermal"]]))

	lib.append(my_data("Ty1","Kelvin",_("Device temperature at y_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Ty1_boundry", "neumann"]]))
	lib.append(my_data("Ty1_boundry","au",_("Boundary condition for y_{max}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_y1","W m^{-2}K^{-1}",_("Conductivity of heat sink y_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Ty1_boundry", "neumann"],["Ty1_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_y1","m",_("Heat sink length y_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Ty1_boundry", "neumann"],["Ty1_boundry", "isothermal"]]))

	lib.append(my_data("Tx0","Kelvin",_("Device temperature at x_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tx0_boundry", "neumann"]]))
	lib.append(my_data("Tx0_boundry","au",_("Boundary condition for x_{min}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_x0","W m^{-2}K^{-1}",_("Conductivity of heat sink x_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Tx0_boundry", "neumann"],["Tx0_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_x0","m",_("Heat sink length x_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tx0_boundry", "neumann"],["Tx0_boundry", "isothermal"]]))

	lib.append(my_data("Tx1","Kelvin",_("Device temperature at x_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tx1_boundry", "neumann"]]))
	lib.append(my_data("Tx1_boundry","au",_("Boundary condition for x_{max}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_x1","W m^{-2}K^{-1}",_("Conductivity of heat sink x_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Tx1_boundry", "neumann"],["Tx1_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_x1","m",_("Heat sink length x_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tx1_boundry", "neumann"],["Tx1_boundry", "isothermal"]]))

	lib.append(my_data("Tz0","Kelvin",_("Device temperature at z_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tz0_boundry", "neumann"]]))
	lib.append(my_data("Tz0_boundry","au",_("Boundary condition for z_{min}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_z0","W m^{-2}K^{-1}",_("Conductivity of heat sink z_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Tz0_boundry", "neumann"],["Tz0_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_z0","m",_("Heat sink length z_{min}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tz0_boundry", "neumann"],["Tz0_boundry", "isothermal"]]))

	lib.append(my_data("Tz1","Kelvin",_("Device temperature at z_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tz1_boundry", "neumann"]]))
	lib.append(my_data("Tz1_boundry","au",_("Boundary condition for z_{max}"),"s",1.0,"QComboBoxLang",defaults=[["isothermal",_("Isothermal")],["neumann",_("Neumann (==0)")],["heatsink",_("Heatsink")]], hide_on_false_token=["#thermal"]))
	lib.append(my_data("heatsink_z1","W m^{-2}K^{-1}",_("Conductivity of heat sink z_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["thermal"],  hide_on_token_eq=[["Tz1_boundry", "neumann"],["Tz1_boundry", "isothermal"]]))
	lib.append(my_data("heatsink_length_z1","m",_("Heat sink length z_{max}"),"e",1.0,"QLineEdit", hide_on_false_token=["#thermal"],  hide_on_token_eq=[["Tz1_boundry", "neumann"],["Tz1_boundry", "isothermal"]]))


	lib.append(my_data("thermal_l",_("True/False"),_("Lattice heat model"),"e",1.0,"gtkswitch",hide_on_token_eq=[["thermal_model_type", "thermal_lattice"]], hide_on_false_token=["thermal"]))
	lib.append(my_data("thermal_e",_("True/False"),_("Electron heat model"),"e",1.0,"gtkswitch",hide_on_token_eq=[["thermal_model_type", "thermal_lattice"]], hide_on_false_token=["thermal"]))
	lib.append(my_data("thermal_h",_("True/False"),_("Hole heat model"),"e",1.0,"gtkswitch",hide_on_token_eq=[["thermal_model_type", "thermal_lattice"]], hide_on_false_token=["thermal"]))

	lib.append(my_data("thermal_max_ittr","au",_("Max thermal solver iterations"),"e",1.0,"QLineEdit"))
	lib.append(my_data("thermal_min_error","au",_("Desired thermal error"),"e",1.0,"QLineEdit"))

	lib.append(my_data("Tliso",_("True/False"),_("Isothermal boundary on left"),"e",1.0,"gtkswitch", hide_on_false_token=["#thermal"]))
	lib.append(my_data("Triso",_("True/False"),_("Isothermal boundary on right"),"e",1.0,"gtkswitch", hide_on_false_token=["#thermal"]))

	#electrical.inp
	lib.append(my_data("electrical_y0_boundry","au",_("Boundary condition for y_{min}"),"s",1.0,"QComboBoxLang",defaults=[["neumann",_("Neumann (==0)")],["interpolate",_("Interpolate")],["constant",_("Constant")]]))
	lib.append(my_data("electrical_y1_boundry","au",_("Boundary condition for y_{max}"),"s",1.0,"QComboBoxLang",defaults=[["neumann",_("Neumann (==0)")],["interpolate",_("Interpolate")],["constant",_("Constant")]]))
	lib.append(my_data("electrical_x0_boundry","au",_("Boundary condition for x_{min}"),"s",1.0,"QComboBoxLang",defaults=[["neumann",_("Neumann (==0)")],["interpolate",_("Interpolate")],["constant",_("Constant")]]))
	lib.append(my_data("electrical_x1_boundry","au",_("Boundary condition for x_{max}"),"s",1.0,"QComboBoxLang",defaults=[["neumann",_("Neumann (==0)")],["interpolate",_("Interpolate")],["constant",_("Constant")]]))

	lib.append(my_data("electrical_y0","V",_("Boundary value for y_{min}"),"s",1.0,"QLineEdit",hide_on_token_eq=[["electrical_y0_boundry", "neumann"],["electrical_y0_boundry", "interpolate"]]))
	lib.append(my_data("electrical_y1","V",_("Boundary value for y_{max}"),"s",1.0,"QLineEdit",hide_on_token_eq=[["electrical_y1_boundry", "neumann"],["electrical_y1_boundry", "interpolate"]]))

	lib.append(my_data("electrical_x0","V",_("Boundary value for x_{min}"),"s",1.0,"QLineEdit",hide_on_token_eq=[["electrical_x0_boundry", "neumann"],["electrical_x0_boundry", "interpolate"]]))
	lib.append(my_data("electrical_x1","V",_("Boundary value for x_{max}"),"s",1.0,"QLineEdit",hide_on_token_eq=[["electrical_x1_boundry", "neumann"],["electrical_x1_boundry", "interpolate"]]))

	lib.append(my_data("thermal_couple_to_electrical_solver",_("True/False"),_("Couple to electrical solver"),"e",1.0,"gtkswitch"))


	#dump.inp
	lib.append(my_data("newton_dump",_("True/False"),_("Dump from newton solver"),"e",1.0,"gtkswitch"))
	lib.append(my_data("plot",_("True/False"),_("Plot bands etc.. "),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_slices",_("True/False"),_("Dump slices"),"e",1.0,"gtkswitch"))
	...
	lib.append(my_data("dump_built_in_voltage",_("True/False"),_("Dump the built in voltage."),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_optical_probe_spectrum",_("True/False"),_("Dump optical probe spectrum"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_optics_summary",_("True/False"),_("Dump optical summary"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_ray_trace_map",_("True/False"),_("Dump raytrace plots"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dumpitdos",_("True/False"),_("Dump DoS"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_file_access_log",_("True/False"),_("Write file access log to disk."),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_use_cache",_("True/False"),_("Use cache for file writes"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_write_headers",_("True/False"),_("Write headers to output files"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_first_guess",_("True/False"),_("Write first guess to equations"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_log_level","au",_("Log verbocity"),"s",1.0,"QComboBoxLang",defaults=[[("none"),_("None")],["screen",_("Screen")],["disk",_("Disk")],["screen_and_disk",_("Screen and disk")]]))
	lib.append(my_data("dump_log_level","au",_("Log verbocity"),"s",1.0,"QComboBoxLang",defaults=[[("none"),_("None")],["screen",_("Screen")],["disk",_("Disk")],["screen_and_disk",_("Screen and disk")]]))
	lib.append(my_data("dump_dynamic_pl_energy",_("True/False"),_("PL dump Energy"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_remove_dos_cache",_("True/False"),_("Clean up DoS cache files"),"e",1.0,"gtkswitch"))
	lib.append(my_data("dump_verbose_electrical_solver_results",_("True/False"),_("Dump verbose electrical solver results"),"e",1.0,"gtkswitch"))

	#pl_ss?.inp
	lib.append(my_data("pl_mode","au",_("Device state"),"s",1.0,"QComboBoxLang",defaults=[[("voc"),_("Voc")],["Jsc",_("Jsc")]]))

	#ray
	lib.append(my_data("ray_wavelength_points","au",_("Wavelength points"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ray_auto_run","au",_("Run the ray tracer"),"s",1.0,"QComboBoxLang",defaults=[[("ray_run_never"),_("Never")],["ray_run_once",_("Once per simulation")],["ray_run_step",_("Each simulation step")]]))

	lib.append(my_data("ray_theta_steps","au",_("Theta steps"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ray_theta_start","Degrees",_("Theta start"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ray_theta_stop","Degrees",_("Theta stop"),"e",1.0,"QLineEdit"))

	lib.append(my_data("ray_phi_steps","au",_("Phi steps"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ray_phi_start","Degrees",_("Phi start"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ray_phi_stop","Degrees",_("Phi stop"),"e",1.0,"QLineEdit"))

	lib.append(my_data("ray_escape_bins","au",_("Escape bins"),"e",1.0,"QLineEdit"))

	lib.append(my_data("ray_auto_wavelength_range",_("True/False"),_("Automatic wavelength range"),"e",1.0,"gtkswitch"))
	lib.append(my_data("ray_lambda_start","nm",_("Start wavelength"),"e",1.0,"QLineEdit",hide_on_true_token="#ray_auto_wavelength_range"))
	lib.append(my_data("ray_lambda_stop","nm",_("Stop wavelength"),"e",1.0,"QLineEdit",hide_on_true_token="#ray_auto_wavelength_range"))
	
	lib.append(my_data("ray_emission_source","au",_("Emit from"),"s",1.0,"QComboBoxLang",defaults=[[("ray_emission_electrical_mesh"),_("Each electrical mesh point")],["ray_emission_single_point",_("Center of each layer")]]))
	lib.append(my_data("text_ray_tracing","au",_("<b>Ray tracing</b>"),"s",1.0,"QLabel"))


	#viewpoint.inp
	lib.append(my_data("viewpoint_enabled",_("True/False"),_("Enable viewpoint"),"e",1.0,"gtkswitch"))
	lib.append(my_data("viewpoint_size","au",_("View point size"),"e",1.0,"QLineEdit"))
	lib.append(my_data("viewpoint_dz","au",_("View point dz"),"e",1.0,"QLineEdit"))
	lib.append(my_data("viewpoint_nx","au",_("Mesh points x"),"e",1.0,"QLineEdit"))
	lib.append(my_data("viewpoint_nz","au",_("Mesh points z"),"e",1.0,"QLineEdit"))
	...
	#parasitic.inp
	lib.append(my_data("Rshunt","Ohms m^{2}",_("Shunt resistance"),"e",1.0,"QLineEdit",min=1e-3,max=1e6))
	lib.append(my_data("Rcontact","Ohms",_("Series resistance"),"e",1.0,"QLineEdit",min=1.0,max=200))
	lib.append(my_data("otherlayers","m",_("Other layers"),"e",1.0,"QLineEdit"))
	lib.append(my_data("test_param","m",_("debug (ignore)"),"e",1.0,"QLineEdit",hidden=True))

	#contacts.inp
	lib.append(my_data("np","m^{-3}",_("Contact charge density"),"e",1.0,"QLineEdit"))

	#mesh?.inp
	lib.append(my_data("remesh_x","au",_("Automatic remesh x"),"e",1.0,"gtkswitch"))
	lib.append(my_data("remesh_y","au",_("Automatic remesh y"),"e",1.0,"gtkswitch"))
	lib.append(my_data("remesh_z","au",_("Automatic remesh z"),"e",1.0,"gtkswitch"))

	#pl?.inp
	lib.append(my_data("pl_emission_enabled",_("True/False"),_("Emission enabled from this layer"),"e",1.0,"gtkswitch"))
	lib.append(my_data("pl_fe_fh","0.0-1.0",_("n_{free} to p_{free} photon generation efficiency"),"e",1.0,"QLineEdit",hide_on_token_eq=[["pl_use_experimental_emission_spectra",True],["pl_emission_enabled",False]]))
	lib.append(my_data("pl_fe_te","0.0-1.0",_("n_{free} to n_{trap} photon generation efficiency"),"e",1.0,"QLineEdit",hide_on_token_eq=[["pl_use_experimental_emission_spectra",True],["pl_emission_enabled",False]]))
	lib.append(my_data("pl_te_fh","0.0-1.0",_("n_{trap} to p_{free} photon generation efficiency"),"e",1.0,"QLineEdit",hide_on_token_eq=[["pl_use_experimental_emission_spectra",True],["pl_emission_enabled",False]]))
	lib.append(my_data("pl_th_fe","0.0-1.0",_("p_{trap} to n_{free} photon generation efficiency"),"e",1.0,"QLineEdit",hide_on_token_eq=[["pl_use_experimental_emission_spectra",True],["pl_emission_enabled",False]]))
	lib.append(my_data("pl_fh_th","0.0-1.0",_("p_{free} to p_{trap} photon generation efficiency"),"e",1.0,"QLineEdit",hide_on_token_eq=[["pl_use_experimental_emission_spectra",True],["pl_emission_enabled",False]]))
	...
	lib.append(my_data("icon",_("Icon"),_("Edit"),"e",1.0,"icon_widget" ,units_widget="QPushButton"))
...
#pl_experimental_emission_efficiency
	...
	#fxdomain?.inp
	lib.append(my_data("is_Vexternal","Volts",_("V_{external}"),"e",1.0,"QLineEdit",hide_on_token_eq=[["load_type","open_circuit"]]))
	lib.append(my_data("fxdomain_Rload","Ohms",_("Load resistor"),"e",1.0,"QLineEdit",hide_on_token_eq=[["load_type","open_circuit"]]))
	...
	lib.append(my_data("fxdomain_norm_tx_function","au",_("Normalize transfer functon by light intensity"),"e",1.0,"gtkswitch",hide_on_token_eq=[["fx_modulation_type","voltage"]]))
	...
	#suns_jsc
	lib.append(my_data("sunstart","Suns",_("Start intensity"), "e",1.0,"QLineEdit"))
	lib.append(my_data("sunstop","Suns",_("Stop intensity"), "e",1.0,"QLineEdit"))
	lib.append(my_data("sundp","au",_("Step"), "e",1.0,"QLineEdit"))
	lib.append(my_data("sundpmul","au",_("step multiplier"), "e",1.0,"QLineEdit"))
	...
	#ce
	lib.append(my_data("ce_start_sun",_("au"),_("Start light intensity"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ce_stop_sun",_("au"),_("Stop light intensity"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ce_number_of_simulations",_("au"),_("Numer of steps"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ce_on_time",_("au"),_("CE light on time"),"e",1.0,"QLineEdit"))
	lib.append(my_data("ce_off_time",_("au"),_("CE light off time"),"e",1.0,"QLineEdit"))

	#fits.data_sets[].config
	lib.append(my_data("time_shift","s","Exp data x shift","e",1.0,"QLineEdit"))
	lib.append(my_data("fit_shift_y","s","Exp data y shift","e",1.0,"QLineEdit"))
	...
	lib.append(my_data("log_y_keep_sign",_("True/False"),_("Keep sign for log y "),"e",1.0,"gtkswitch"))
	...
	lib.append(my_data("fit_against", "au", _("Fit against simulation"),"e",1.0,"QComboBoxLang"))
	...
	#fdtd.inp
	lib.append(my_data("use_gpu","au",_("OpenCL GPU acceleration"),"e",1.0,"gtkswitch"))
	lib.append(my_data("fdtd_lambda_start","m",_("Start wavelength"),"e",1.0,"QLineEdit"))
	lib.append(my_data("fdtd_lambda_stop","m",_("Stop wavelength"),"e",1.0,"QLineEdit"))
	lib.append(my_data("fdtd_lambda_points","m",_("Wavelength steps"),"e",1.0,"QLineEdit"))

	#any files
	lib.append(my_data("dump_verbosity","au",_("Output verbosity to disk"),"e",1.0,"QComboBoxLang",defaults=[["-1",_("Nothing")],["0",_("Key results")],[("1"),_("Write everything to disk")],[("2"),_("Write everything to disk every 2nd step")],[("5"),_("Write everything to disk every 5th step")],[("10"),_("Write everything to disk every 10th step")]]))
	lib.append(my_data("dump_screen_verbosity", "au", _("Output verbosity to screen"),"e",1.0,"QComboBoxLang",defaults=[[("dump_verbosity_everything"),_("Show lots")],["dump_verbosity_key_results",_("Show key results")]]))

	lib.append(my_data("solver_verbosity", "au", _("Solver output verbosity"),"e",1.0,"QComboBoxLang",defaults=[[("solver_verbosity_nothing"),_("Nothing")],["solver_verbosity_at_end",_("As answers are found")],["solver_verbosity_every_step",_("Each step")]]))

	#circuit diagram
	lib.append(my_data("com_R","Ohms",_("Resistor"),"e",1.0,"QLineEdit"))
	lib.append(my_data("com_C","F",_("Capacitor"),"e",1.0,"QLineEdit"))
	lib.append(my_data("com_L","H",_("Inductance"),"e",1.0,"QLineEdit"))
	lib.append(my_data("com_I0","Apms",_("I0"),"e",1.0,"QLineEdit"))
	lib.append(my_data("com_nid","(a.u.)",_("Ideality factor"),"e",1.0,"QLineEdit"))
	lib.append(my_data("com_layer","(a.u.)",_("Layer"),"e",1.0,"QComboBoxLayers"))

	#gl
	lib.append(my_data("xRot","Deg",_("x rotation"),"e",1.0,"QLineEdit"))
	lib.append(my_data("yRot","Deg",_("y rotation"),"e",1.0,"QLineEdit"))
	lib.append(my_data("zRot","Deg",_("z rotation"),"e",1.0,"QLineEdit"))
	lib.append(my_data("x_pos","au",_("x pos"),"e",1.0,"QLineEdit"))
	lib.append(my_data("y_pos","au",_("y pos"),"e",1.0,"QLineEdit"))
	lib.append(my_data("zoom","au",_("zoom"),"e",1.0,"QLineEdit"))

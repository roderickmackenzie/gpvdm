...
class json_ray_view_point(json_base):
	...
	def __init__(self):
		...
		self.var_list=[]
		self.var_list.append(["viewpoint_enabled",True])
		self.var_list.append(["viewpoint_size",0.8])
		self.var_list.append(["viewpoint_dz",0.1])
		self.var_list.append(["viewpoint_nx",120])
		self.var_list.append(["viewpoint_nz",1])
		self.var_list_build()
...
class json_ray_simulation(json_base):
	...
	def __init__(self):
		...
		self.var_list.append(["viewpoint",json_ray_view_point()])
		self.var_list_build()

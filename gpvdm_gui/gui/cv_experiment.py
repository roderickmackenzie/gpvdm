...
class cv_experiment(experiment):
	...
	def __init__(self):
		experiment.__init__(self,window_save_name="cvexperiment_editor", window_title=_("CV experiment window"),name_of_tab_class="cvexperiment_tab",json_search_path="gpvdm_data().cv")

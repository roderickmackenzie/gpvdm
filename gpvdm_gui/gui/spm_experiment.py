...
class spm_experiment(experiment):
	...
	def __init__(self):
		experiment.__init__(self,window_save_name="spmexperiment_editor", window_title=_("Scanning probe microscopy editor"),name_of_tab_class="jvexperiment_tab",json_search_path="gpvdm_data().spm")
